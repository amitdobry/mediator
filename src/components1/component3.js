    ...
    render() {
        return (
            ...
            <div>
                ...
                <h2 class="downabit2" style={{color: 'darkmagenta'}}>What Does Papu the Mediator do?</h2>
                <h2 class="purp-text2">
                ...
                <h2 class="downabit2" style={{color: 'darkmagenta'}}>why should we use papo the mediator?</h2>
                <h2 class="purp-text2">
                    <ul class="silver-background">
